    ...
    <div v-else class="max-w-4xl mx-auto">
      ...
      <div v-if="isPending" class="flex items-center gap-4">
        <div class="relative w-8 h-8">
          <svg class="absolute top-0 left-0 w-full h-full animate-gemini-spinner-container" viewBox="0 0 24 24">
            <defs>
              <linearGradient :id="gradientId" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stop-color="#FF8A65" />   <stop offset="50%" stop-color="#FFEB3B" />  <stop offset="100%" stop-color="#69F0AE" />  </linearGradient>
            </defs>
            
            <circle cx="12" cy="12" r="11" fill="none" stroke-width="2" class="stroke-gray-200" opacity="0.3"></circle>
            
            <circle cx="12" cy="12" r="11" fill="none" :stroke="`url(#${gradientId})`" stroke-width="2" class="animate-gemini-spinner-arc"
